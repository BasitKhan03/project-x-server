...
LEFT JOIN PersistentAttendanceLogs PAL_present ON E.EmployeeId = PAL_present.PersistentAttendanceLogId AND PAL_present.time_in IS NOT NULL AND PAL_present.time_out IS NOT NULL
LEFT JOIN PersistentAttendanceLogs PAL_absent ON E.EmployeeId = PAL_absent.PersistentAttendanceLogId AND (PAL_absent.time_in IS NULL OR PAL_absent.time_out IS NULL)
